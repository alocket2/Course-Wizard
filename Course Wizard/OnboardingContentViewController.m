...
- (void)generateView {
    ...
    if (_buttonText) {
        ...
        _actionButton.titleLabel.font = [UIFont boldSystemFontOfSize:self.buttonFontSize];
        ...
        [_actionButton addTarget:self action:@selector(handleButtonPressed) forControlEvents:
